          ...
          {!loading && !error && articles && articles.length > 0 && (
            <>
              ...
              {showCount < articles.length && (
                <button
                  className={`show-more-btn${showMoreActive ? " active" : ""}`}
      ...
      <section className="about-author">
        ...
        <div className="author-info">
          ...
          <p>
            ...
            Baruc combines technical expertise with creativity to build
            responsive and engaging websites. When not coding, Baruc enjoys
